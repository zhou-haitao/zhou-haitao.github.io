...
The class provides the following primitives:
    ...
    is used by the worker-side to retrieval/load KV cache.
        estimate_num_blocks_required() - get the number of required blocks.
...
class UcmSparseBase(ABC):
    ...
    def bind_sparse_metadata(
            self, sparse_metadata: UcmSparseMetadata) -> None:
    ...
    def request_finished_in_worker(self):
        """
    ...
    def estimate_num_blocks_required(self, request: Request):
        """
    ...
    def build_sparse_meta(self, scheduler_output: SchedulerOutput) -> UcmSparseMetadata:
        """
